...
[go-nsq_104]: https://github.com/blueshift-labs/go-nsq/releases/tag/v1.0.4
...
We now provide a single Docker image [`blueshift-labs/nsq`](https://registry.hub.docker.com/u/blueshift-labs/nsq/)
...
release notes](https://github.com/blueshift-labs/go-nsq/releases/tag/v1.0.3).
...
switch. For details see #404 and the associated changes in blueshift-labs/go-nsq#83 and blueshift-labs/pynsq#98.
...
via `github.com/blueshift-labs/nsq/nsqd`, thanks to @kzvezdarov.
 ...
 * #325 - make `nsqd` importable (`github.com/blueshift-labs/nsq/nsqd`) (thanks @kzvezdarov)
 ...
 * blueshift-labs/go-nsq#19 and blueshift-labs/go-nsq#29 - fix deadlocks on `nsq.Reader` connection close/exit, this
...
dependencies.  If you're on go1.1+ you can now just use `godep get github.com/blueshift-labs/nsq/...`.
 ...
 * #264 moved **go-nsq** to its own [repository](https://github.com/blueshift-labs/go-nsq)

## pynsq Python Client Library

 * #88 moved **pynsq** to its own [repository](https://github.com/blueshift-labs/pynsq)
