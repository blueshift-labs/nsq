module github.com/blueshift-labs/nsq
...
require (
	...
	github.com/blueshift-labs/badgerq v1.0.1
	github.com/blueshift-labs/go-diskqueue v1.0.0
	github.com/blueshift-labs/go-nsq v1.0.7-badgerq
