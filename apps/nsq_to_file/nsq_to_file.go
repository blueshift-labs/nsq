...
func flagSet() *flag.FlagSet {
	...
	fs.Var(&consumerOpts, "consumer-opt", "option to passthrough to nsq.Consumer (may be given multiple times, http://godoc.org/github.com/blueshift-labs/go-nsq#Config)")
